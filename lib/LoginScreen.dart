...
class LoginScreen extends StatelessWidget {
                      ...
                      children: <Widget>[
                        ...
                        InkWell(
                          child: Text("Registrarse",
                            style: TextStyle(color: Colors.green[900],fontSize: 14.0,fontWeight: FontWeight.bold),),
  ...
  Login(BuildContext context) async {
    ...
    if(typeUser){
     ...
     consultaFirebase(user,child,context);

  }

  void consultaFirebase(ItemUser usuario,String child,BuildContext context){

    ref.child(child).orderByChild("correo").equalTo(usuario.getCorreo()).once().then((DataSnapshot data){
      if(data.value != null){
