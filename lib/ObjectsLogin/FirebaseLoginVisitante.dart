...
class FirebaseLoginVisitante extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ref = FirebaseDatabase.instance
        .reference(); //obtenemos la referencia de la base de datos
                      ...
                      InkWell(
                        ...
                        onTap: () {
                          ...
                          Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => RegisterVisita(),
                          ));
                        },
                      ),
                      SizedBox(
